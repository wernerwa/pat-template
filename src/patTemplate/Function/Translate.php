...
class patTemplate_Function_Translate extends patTemplate_Function
{
     ...
     */
    public function _retrieveGlobalConfig()
    {
        /**
     ...
     */
    public function _retrieveConfig($input)
    {
     ...
     * @return   boolean     true on success
     */
    public function _loadTranslationFile($input)
    {
        foreach ($this->_globalconfig['lang'] as $lang) {
     ...
     * @return   string
     */
    public function _unescape($text)
    {
     ...
     * @return   boolean
     */
    public function _updateTranslationFiles($input, $key, $content)
    {
        $success = true;
     ...
     * @return   boolean
     */
    public function _updateTranslationFile($input, $key, $content)
    {
        $fp = @fopen($input, 'a');
        if (!$fp) {
            return false;
