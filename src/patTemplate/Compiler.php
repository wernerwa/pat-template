...
class patTemplate_Compiler extends patTemplate
{
     ...
     */
    public function compile($compileName = null)
    {
     ...
     * @param    string      name of the template
     */
    public function _compileStandardTemplate($template)
    {
     ...
     */
    public function _compileModuloTemplate($template)
    {
     ...
     * @param    string      name of the template
     */
    public function _compileSimpleConditionTemplate($template)
    {
        $conditions =   array();
     ...
     * @param    string      name of the template
     */
    public function _compileConditionTemplate($template)
    {
        /**
         * __first, __last
         */
     ...
     */
    public function _compileBuiltinConditions($template)
    {
     ...
     */
    public function _templateToPHP($content, $template)
    {
     ...
     * @return   void
     */
    public function _addToCode($line, $indent = 0, $comment = null)
    {
        if (!is_null($comment)) {
            fputs($this->_fp, "\n");
            if ($indent > 0) {
     ...
     */
    public function _getVar($template, $varname)
    {
     ...
     * @param    string      template name
     */
    public function _prepareCompiledTemplate($template)
    {
