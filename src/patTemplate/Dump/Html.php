...
class patTemplate_Dump_Html extends patTemplate_Dump
{
     ...
     */
    public function _displayAttributes($tmpl, $tmplName = null)
    {
     ...
     */
    public function _highlightVars($template, $vars)
    {
     ...
     */
    public function _useBorders($state)
    {
     ...
     * @param    mixed       value, you may pass more than one value
     */
    public function _displayLine($prop, $value)
    {
        $args   =   func_get_args();
